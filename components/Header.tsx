...
export default function Header() {
  ...
  return (
    <header
      className={`bg-white shadow-md m-7 rounded-4xl fixed top-0 left-0 right-0 z-50 transition-all duration-300 ease-in-out ${
        isVisible
      ...
      <div className="max-w-8xl mx-auto  sm:px-4 lg:px-6 ">
        <div className="flex justify-between items-center h-20">
          <div className="flex-shrink-0">
            <Link
              href="/"
              className="text-4xl font-serif font-medium text-gray-900 tracking-tight"
            >
              whattaplace
            </Link>
          </div>
